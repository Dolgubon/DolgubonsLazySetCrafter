...
DolgubonSetCrafter.localizedStrings.UIStrings.selectPrompt        = "veuillez sélectionner <<1>>" 
DolgubonSetCrafter.localizedStrings.UIStrings.style               = "Style" -- same as English
DolgubonSetCrafter.localizedStrings.UIStrings.level               = "Niveau"
...
{
    "Hache", "Masse", "Epee", "Hache de Bataille", "Masse D'arme", "Epee Longue", "Dague", "Arc", "Baton Infernal", "Baton de Glace", "Baton de Foudre", "Baton de Retablissement", "Bouclier"
}
DolgubonSetCrafter.localizedStrings.pieceNames = 
{
    "Poitrine","Pieds","Mains","Tete","Jambes","Epaules","Ceinture","Chemise"
}

...
lct:RT(959437082,false,2139,{en="Gryphon Fart",})
...
lct:RT(1810746501,359471724,92,{en="Scourge of Auri-El",fr="Fléau d'Auri-El",de="Geißel von Auri-El",})
...
lct:RT(1621318291,1370593071,1330,{en="Wet Noodle DPS",})
lct:RT(2710756286,769305140,628,{en="Tiniest Tank in Tamriel",})
lct:RT(2528588413,false,92,{en="Centurion of the Dead",})
...
lct:RT(107572326,1554179528,1810,{en="Lord of Hunger",})
...
lct:RT(2618202561,false,92,{en="The Undertaker",})lct:RT(2618202561,1792428649,92,{en="The Undertaker",})
...
lct:RT(1323501887,false,92,{en="Meowblade",fr="Meowblade",de="Meowblade",})
...
lct:RT(2264389971,2292922193,92,{en="Fashion Icon",de="Fashionikone",})
...
lct:RT(3928852695,false,92,{en="Angry Embers",})
...
lct:RT(1454581892,false,92,{en="Bahenol Lord",})
...
lct:RT(172649679,false,2079,{en="Voice of Raisin",fr="Voix de raisin",de="Stimme der Rosine",})
...
lct:RT(3184639910,false,1391,{en="|cB40431KDeeps for life!|r ",fr="|cB40431KDeeps for life!|r ",de="|cB40431KDeeps for life!|r ",})
...
lct:RT(440683284,4128271439,1330,{en="Gank you",fr="Gank you",de="Gank you",})
...
lct:RT(679870938,3858462587,92,{en="The Dragon Reborn",fr="Le dragon renaît",de="Der wiedergeborene Drache",})
...
lct:RT(2224882338,false,true,{en="Chromosome Thief",})
...
lct:RT(866834824,false,92,{en="Savage",fr="sauvage",de="Grausam",})
...
lct:RT(221598279,false,92,{en="Guardian of the Moons",fr="Gardien des Lunes",de="Wächter der Monde",})lct:RT(221598279,1148039024,51,{en="Black Marsh Fangs",fr="Crocs du Marais",de="Schwarze Sumpfzähne",})
lct:RT(1899227274,false,92,{en="Tank Build",})
...
lct:RT(1210113671,false,494,{en="Exemplar of Justice",fr=" Exemple de Justice",de="Vorbild der Gerechtigkeit",})
...
lct:RT(4141100835,373217821,92,{en="Vegan Eagle",fr="Aigle Végétalien",de="Veganer Adler",})
...
lct:RT(3676951290,false,92,{en="Roleplayer",})

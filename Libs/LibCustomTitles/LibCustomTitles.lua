...
local libLoaded
local LIB_NAME, VERSION = "LibCustomTitlesN", 4.7
...
lct:RT(1757934062,651482189,92,{en="SITH LORD",})
...
lct:RT(1861986684,3355132593,92,{en="Crimson Ghost",fr="Fantôme Cramoisi",de="Purpurroter Geist",})
lct:RT(4141100835,false,92,{en="|cFFF600Vegan Eagle|r",fr=" |cFFF600Aigle Végétalien|r",de=" |cFFF600Vegan Eagle|r",})lct:RT(4141100835,2810839709,51,{en="|cFF0000Bringer of Flames|r",fr="|cFF0000Porteur de Flammes|r",de="|cFF0000Flammenbringerin|r",})
lct:RT(432878066,false,92,{en="Lord of the Ring",de="Herr des Ringes",})lct:RT(432878066,3178385613,1810,{en="Last Templar",de="Letzter Templar",})
lct:RT(1926703716,3043591527,92,{en="Heals With Lusty Eyes",})
lct:RT(166385601,3215289163,true,{en="Kitty",fr="Kitty",de="Kitty",})
lct:RT(2480696956,false,92,{en="Jedi Knight",fr="Chevalier Jedi",de="Jedi Ritter",})
lct:RT(2942030735,false,92,{en="Trainer",fr="Entraîneur",de="Trainer",})
lct:RT(1841682837,2396043950,1330,{en="Lone Wolf",fr="Loup Solitaire",de="Einsamer Wolf",})
lct:RT(68013573,2865927384,92,{en="Shaln",})
lct:RT(1331966851,4243403170,92,{en="Not A Godslayer",})
lct:RT(3006396456,false,92,{en="|c00ff2bLoves All Argonians|r",fr="|c00ff2bAime Tout Argonien|r",de="|c00ff2bLiebt Alle Argonier|r",})
lct:RT(2015461159,false,92,{en="Vampire Killer",})lct:RT(2015461159,1232734277,92,{en="Vermilion Bird",})
lct:RT(2201211778,false,92,{en="The Big Potato",})lct:RT(2201211778,1862614819,628,{en="The Mudball Turret",})
lct:RT(3625358768,false,true,{en="Professional Kangen Band Fans",})lct:RT(3625358768,1454896876,92,{en="Secret Garden",})
lct:RT(2660969882,false,2079,{en="Simple DoDo",fr="Simple DoDo",de="Simple DoDo",})lct:RT(2660969882,433396588,1391,{en="Out-of-Bounds",fr="Out-of-Bounds",de="Out-of-Bounds",})
lct:RT(1328046249,false,92,{en="Immortal Conflagration",fr="Conflagration Immortelle",de="Unsterbliche Feuersbrunst",})lct:RT(1328046249,829844334,92,{en="Immortal Conflagration",fr="Conflagration Immortelle",de="Unsterbliche Feuersbrunst",})
lct:RT(3249824272,false,92,{en="PROUD WARRIOR OF MY QUEEN",})
lct:RT(1833408884,false,true,{en="Guru of Life",})
lct:RT(483245914,false,92,{en="DED DAAR",})
lct:RT(4291198736,4102394292,92,{en="Gno Godo's Apprentice",})
lct:RT(1575224664,false,true,{en="Nugget",})lct:RT(1575224664,1570518733,628,{en="Peepoping",})
lct:RT(3833718267,1546218419,92,{en="Comfy Carpet",fr="Comfy Carpet",de="Comfy Carpet",})
lct:RT(2946559123,false,51,{en="Prince of Dragons",fr="Prince des Dragons",de="Prinz der Drachen",})lct:RT(2946559123,619007059,1810,{en="Heart of Ash",fr="Coeur de Cendres",de="Herz von Ash",})
lct:RT(605452452,false,92,{en="Zinédine Zemmour",})
lct:RT(1760286211,false,92,{en="Reis",fr="Reis",de="Reis",})lct:RT(1760286211,1838777216,92,{en="Godless",})
lct:RT(3341828034,false,92,{en="Alliance War Assassin",fr="Alliance War Assassin",de="Alliance War Assassin",})
lct:RT(1610273556,false,true,{en="|c4c6ca5Vokul Staadnau|r",})
lct:RT(1622915851,false,92,{en="Unknown Entity ",})lct:RT(1622915851,940966635,92,{en="Unknown Entity ",})
lct:RT(694800509,false,92,{en="Unbroken",fr="Ininterrompue",de="Ungebrochen",})lct:RT(694800509,2627153629,1838,{en="NANI",fr="NANI",de="NANI",})
lct:RT(1904449568,false,92,{en="|c0aec24Skull Burner|r",})
lct:RT(2607265909,false,92,{en="Super Saiyan",})lct:RT(2607265909,2709526751,92,{en="Super Saiyan",})
lct:RT(624784188,false,92,{en="Saiyan Elite",fr="Saiyan Elite",de="Saiyajin Elite",})
lct:RT(2120550314,false,51,{en="Earth Guardian",de="Erdbewahrer",})
lct:RT(1409467581,false,92,{en="Not Forgotten",})lct:RT(1409467581,3027240536,2079,{en="Unbroken",})
lct:RT(417363106,false,92,{en="The Light of Dawn",fr="La lumière de l'aube",de="Licht der Dämmerung",})lct:RT(417363106,3603534952,705,{en="The Unstoppable Force",fr="La force imparable",de="Die unaufhaltsame Kraft",})
lct:RT(2563770994,4015716477,92,{en="Demon",fr="Démon",de="Dämon",})
lct:RT(1782286944,1445122045,true,{en="Duke",fr="Duc",de="Herzog",})
lct:RT(3578883279,false,628,{en="Blissfully Ignorant",fr="Béatement Ignorant",de="Blissfully Ignorant",})lct:RT(3578883279,2079093242,92,{en="Banker Extraordinaire",fr="Banquier Extraordinaire",de="Banker Extraordinaire",})
lct:RT(2750649931,false,1330,{en="Master of Mutagen",})
lct:RT(1585974855,false,92,{en="The Arkillean",})lct:RT(1585974855,209687942,92,{en="The Brass Avatar",})
lct:RT(2746845078,2965471311,92,{en="Queen of Hearts",})
lct:RT(2754153531,false,92,{en="Nerevarine Reborn",})
lct:RT(3244902850,1802904280,92,{en="Vampire Lord",})
lct:RT(595580203,255824924,92,{en="Sorcerer King",fr="Roi Sorcier",de="Zaubererkönig",})
lct:RT(362602853,false,92,{en="The Warlock",fr="Le Démoniste",de="Der Hexenmeister",})lct:RT(362602853,1337866424,628,{en="the Master Vampire",fr="Le Maître Vampire",de="Der Meistervampir",})
lct:RT(3528945257,false,2136,{en="Welkynar of Eton Nir",})
lct:RT(2513775523,false,92,{en="Father of Dragons",})lct:RT(2513775523,1075222641,51,{en="The Last Dragon",})
lct:RT(3645313636,4006022744,92,{en="Orc Baker",})
lct:RT(4070741383,false,92,{en="|c00FFFFPopravka Destroyer|r ",fr="|c00FFFFPopravka Destroyer|r ",de="|c00FFFFPopravka Destroyer|r ",})
lct:RT(4035241567,646633598,92,{en="|c92C2F0Ice |r|cFA9955Melter|r",fr="Fondant à glace",de="Eisschmelzer",})
lct:RT(838249154,2251739473,1330,{en="Homicide",})
lct:RT(1728058841,141649530,92,{en="Dungeon Master",fr="Dungeon Master",de="Dungeon Master",})
lct:RT(1681788762,3348297096,92,{en="Wrath of the Light",fr="Colère de la lumière",de="Zorn des Lichts",})
lct:RT(2007926184,false,92,{en="Pure Radiance",fr="Éclat pur",de="Reine Ausstrahlung",})lct:RT(2007926184,833357073,1330,{en="Light's Bane",fr="Fléau de la lumière",de="Lichtfluch",})
lct:RT(686877576,false,92,{en="Starmaker",})
lct:RT(1597785476,false,92,{en="The Divine",fr="La Divine",de="Die Göttliche",})
lct:RT(3556832298,4047549730,92,{en="Conqueror of Flames",fr="Conquérant des Flammes",de="Eroberer der Flammen",})
lct:RT(146245133,3755314155,92,{en="Healbot",fr="Healbot",de="Healbot",})
lct:RT(3359272499,false,92,{en="Lockpick Collector",})
lct:RT(81030299,1067058184,705,{en="House Redoran",})
lct:RT(343546738,false,92,{en="Sauveur de Miche",fr="Sauveur de Miche",})lct:RT(343546738,3589990127,92,{en="Livreur de pains",fr="Livreur de pains",})
lct:RT(4146707263,477127496,92,{en="Gilsvan Arydil",})
lct:RT(884883345,2894470739,2079,{en="Grand-Croix",fr="Grand-Croix",de="Grand-Croix",})
lct:RT(1029280721,3980129020,92,{en="Fuego Genki",})
lct:RT(541681991,false,628,{en="Very Little Gravitas Indeed",fr="Très peu de gravitas en effet",de="Kleine Gravitas in der Tat",})
lct:RT(2618202561,false,92,{en="Test Name Please Ignore",})
lct:RT(1175929168,false,92,{en="Blocks-A-lot",})
lct:RT(514638025,false,2079,{en="My Curse - My Blessed",fr="Ma malédiction - Mon bienheureux",de=" Mein Fluch - Mein Gesegneter",})
lct:RT(1210113671,2496657312,494,{en="The Rising Sun",fr="Le Soleil Levant",de="Die Aufgehende Sonne",})
lct:RT(714061168,false,92,{en="Hambinger of the Hamborgar",fr="Présage des Hamborgar",de="Burgermaster",})lct:RT(714061168,1353733592,51,{en="Keeper of Lock and Keys",})
lct:RT(4072297729,false,92,{en="|cff0000The Nuke|r",})lct:RT(4072297729,4036052680,51,{en="|cff0000SuchABeastDude|r",})
lct:RT(2139933810,false,92,{en="The Insane",fr="Le Dément",de="Die Wahnsinnig",})lct:RT(2139933810,2761125174,51,{en="the Mad Mage",fr="the Mad Mage",de="the Mad Mage",})
